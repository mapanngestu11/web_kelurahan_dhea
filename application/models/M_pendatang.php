...
{
    $this->db->select('Count(id_surat_datang) as jumlah ');
    $this->db->from('tbl_surat_datang');

    $this->db->where('MONTH(tanggal)',$bulan);
    $this->db->order_by('id_surat_datang');
...
{
    $this->db->select('Count(id_surat_datang) as jumlah_setuju ');
    $this->db->from('tbl_surat_datang');
...
{
    $this->db->select('Count(id_surat_datang) as jumlah_proses ');
    $this->db->from('tbl_surat_datang');
...
{
    $this->db->select('Count(id_surat_datang) as jumlah_tolak ');
    $this->db->from('tbl_surat_datang');
