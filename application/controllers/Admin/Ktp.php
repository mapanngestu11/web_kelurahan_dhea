    ...
    //Compress Image
        ...
        if ($cek_status == '3') {
          $mail->isSMTP();      
            ...
            <br>
            <p>Salam Sejahtera,</p>
            <h3>Terima Kasih, <strong>'.$nama.'</strong></h3> <p> sudah melakukan <strong>Permohonan KTP</strong>.</p><p> Permohonan KTP dengan nomor : <strong>' .$kode_permohonan. ' </strong>, Saat ini : <strong> '.$cek_status.' </strong> , Mohon untuk datang Ke Kelurahan Karang Timur Setelah 2 -3 Hari Setelah Menerima email ini untuk mengambil dokumen tersebut. <br></p> 
            <br>
