  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><span class="badge badge-primary">Permohonan Pindah</span></h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url('Admin/Homepage/') ?>">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Permohonan pindah</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Permohonan Pindah</h6>
                  <!--  <button class="btn btn-primary block" style=" float: right;" data-toggle="modal" data-target="#default" data-backdrop="static" data-keyboard="false">Tambah Pindah Baru</button> -->
                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="myModalLabel1">Tambah Pindah Baru</h5>
                        ...
                        <div class="modal-body">
                          <div class="modal-body">
                            ...
                            <form action="<?php echo base_url() . 'Admin/Pindah/add'; ?>" method="post" enctype="multipart/form-data" id="tambah_warga" class="tambah_warga">
                              <div class="row">
                                <div class="col-md-6">
                                  <label>Nik</label>
                                  <div class="form-group form-input">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-button-action">
                            ...
                            <!--   <a class="btn btn-link btn-warning btn-lg" data-toggle="modal" data-target="#ModalEmail<?php echo $id_surat_pindah; ?>"><i class=" fa fa-envelope" data-original-title="Edit Task" style="color:white;"></i></a> -->
                          </div>
                        </td>
                      <?php endforeach; ?>
          ...
          <div class="modal fade" id="ModalHapus<?php echo $id_surat_pindah; ?>" tabindex="-1" role="dialog" aria-labelledby="">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'Admin/Pindah/delete' ?>" method="post">
                  <div class="modal-body">
          ...
          <div class="modal fade " id="ModalEdit<?php echo $id_surat_pindah; ?>" role="dialog" aria-hidden="true" data-backdrop="static">>
            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="modal-body">
                    <form action="<?php echo base_url() . 'Admin/Pindah/update'; ?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-12">
                          <label>Kode Permohonan</label>
                          <div class="form-group form-input">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="form-group form-input">
                            <input type="text" name="alamat" value="<?php echo $row['alamat_lama']; ?>" class="form-control" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <label>File Lampiran Surat Keterangan</label>
                          <div class="form-group form-input">
                            <a href="<?php echo base_url() . "assets/upload/"; ?><?php echo $row['selfi_pemohon'];?>" target="_blank" class="btn btn-primary">File Lampiran</a>
                          </div>
                        </div>
      ...
      <?php foreach ($pindah->result_array() as $row) :
        ...
        $nama = $row['nama'];
        ?>
        <div class="modal fade" id="ModalEmail<?php echo $id_surat_pindah; ?>" tabindex="-1" role="dialog" aria-labelledby="">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <!--    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button> -->
              ...
              <form class="form-horizontal" action="<?php echo base_url() . 'Admin/Pindah/kirim_email' ?>" method="post">
                <div class="modal-body">
                  <input type="hidden" name="id_surat_pindah" value="<?php echo $id_surat_pindah; ?>" />
                  <div class="row">
