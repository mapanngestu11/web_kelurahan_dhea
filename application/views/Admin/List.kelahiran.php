      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><span class="badge badge-primary">Kelahiran</span></h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url('Admin/Homepage/') ?>">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Kelahiran</li>
            </ol>
          </div>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="myModalLabel1">Tambah Kelahiran</h5>
                        ...
                        <div class="modal-body">
                          <div class="modal-body">
                            ...
                            <form action="<?php echo base_url() . 'Admin/Kelahiran/add'; ?>" method="post" enctype="multipart/form-data" id="tambah_warga" class="tambah_warga">
                              <div class="row">
                                <div class="col-md-6">
                                  <label>Nik</label>
                                  <div class="form-group form-input">
          ...
          <div class="modal fade" id="ModalHapus<?php echo $id_surat_kelahiran; ?>" tabindex="-1" role="dialog" aria-labelledby="">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'Admin/Kelahiran/delete' ?>" method="post">
                  <div class="modal-body">
        ...
        <?php foreach ($kelahiran->result_array() as $row) :
          ...
          ?>
          <div class="modal fade " id="ModalEdit<?php echo $id_surat_kelahiran; ?>" role="dialog" aria-hidden="true" data-backdrop="static">>
            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="myModalLabel1">Proses Data</h5>
                  <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                    <i data-feather="x"></i>
                  </button>
                </div>
                ...
                <div class="modal-body">
                  <div class="modal-body">
                    <form action="<?php echo base_url() . 'Admin/Kelahiran/update'; ?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-md-12">
                          <label>Kode Permohonan</label>
                          <div class="form-group form-input">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group form-input">
                            <input type="text" name="nama_anak" value="<?php echo $row['nama_anak']; ?>" class="form-control" readonly>
                          </div>
                        </div>
                        <div class="col-md-6">
