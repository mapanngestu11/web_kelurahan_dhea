                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="btn-skpwni">
                                <a href ="<?php echo base_url('Kelahiran/pilih_pengajuan_surat_kelahiran/') ?>" class="btn btn--radius-2 btn--blue">Surat Kelahiran</a>
                            </div>
                            <div class="btn-skdwni">
                                <a href ="<?php echo base_url('kematian/pilih_pengajuan_surat_kematian') ?>" class="btn btn--radius-2 btn--blue">Surat Kematian</a>
                            </div>
                        </div>
