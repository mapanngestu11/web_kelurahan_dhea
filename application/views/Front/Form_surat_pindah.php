    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Pembuatan Surat Pindah</h2>
                    <form action="<?php echo base_url('Pengajuan/input_data_surat_pindah') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-2">
                        <div class="input-group">
                            ...
                            <input class="input--style-4" type="text" name="nama" required="" autocomplete="off">
                        </div>
                    </div>
                ...
                <div class="input-group">
                    <label>Upload Surat pindah (Daerah Asal)</label>
